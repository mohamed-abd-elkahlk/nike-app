  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="font-montserrat text-slate-gray text-lg leaSding-8 mt-6 mb-16 sm:max-w-sm ">
      ...
      <div className="relative flex flex-1 justify-centeri items-center xl:min-h-full max-xl:py-40 bg-primary  bg-hero bg-center">
        <img
          src={bigShoe}
          alt=""
          width={610}
